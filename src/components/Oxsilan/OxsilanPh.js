...
const OxsilanPh = () => {
  ...
  const fetchData = async (interval) => {
    ...
    try {
      const response = await axios.get(`http://localhost:5002/api/pumpmotorcurrent/OXPHLBL?startDate=${startDate}&endDate=${endDate}`);
        ...
        <div className="row">
          <div className="col-md-12 mb-4">
            <div className="card">
              ...
              <h4 className="font-weight-bold">PH</h4>
